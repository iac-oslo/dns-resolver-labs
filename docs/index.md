...
| [lab-05](labs/lab-05/index.md) | Hub-Spoke | Resolver in hub resolves PE from both spokes |
| [lab-06](labs/lab-06/index.md) | Hub-Spoke | Resolver forwards DNS to on-prem workload from spokes |
| [lab-08](labs/lab-08/index.md) | Hub-Spoke + Azure Firewall | AzFW DNS Proxy + Resolver resolves PE |
| [lab-09](labs/lab-09/index.md) | Hub-Spoke + Azure Firewall | AzFW DNS Proxy + Resolver forwards to on-prem DNS |

## Workshop structure

Labs are organized into three infrastructure sets. Deploy each set before running the corresponding labs, then clean up to save costs.

| IaC Set | Labs | Cost (3h) |
|---------|------|-----------|
| Set 1 — Single VNet | lab-01, lab-02, lab-03 | ~$1.88 |
| Set 2 — Hub-Spoke | lab-04, lab-05, lab-06 | ~$1.92 |
| Set 3 — Hub-Spoke + AzFW | lab-07, lab-08, lab-09 | ~$2.94 |
