...
| [lab-09](labs/lab-09/index.md) | Secured VWAN + Azure Firewall | AzFW DNS Proxy + Resolver resolves PE |
| [lab-10](labs/lab-10/index.md) | Secured VWAN + Azure Firewall | AzFW DNS Proxy + Resolver forwards to on-prem DNS |
...
| Set 3 — Secured VWAN + AzFW | lab-08, lab-09, lab-10 | ~$2.45 |
